...
stb
===
[Full STB Library](https://github.com/nothings/stb)
...
--------------------- | ---- | -------- | --- | --------------------------------
**[stb_image.h](https://github.com/nothings/stb/blob/master/stb_image.h)** | 2.30 | graphics | 7988 | image loading/decoding from file/memory: JPG, PNG, TGA, BMP, PSD, GIF, HDR, PIC
